...
//--------------------------------------------------------------------------------------------------------------------------------------
#define MQTT_HOST			"a18BP50eRCH.iot-as-mqtt.cn-shanghai.aliyuncs.com" 		// MQTT服务端域名/IP地址	// the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
#define MQTT_PORT       	1883    										// 网络连接端口号			// the listening port of your MQTT server or MQTT broker
#define MQTT_CLIENT_ID   	"123456|securemode=3,signmethod=hmacsha1|"	// 官方例程中是"Device_ID"		// 客户端标识符				// the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
#define MQTT_USER        	"Esp8266Test&a18BP50eRCH" 			// MQTT用户名				// your MQTT login name, if MQTT server allow anonymous login,any string is OK, otherwise, please input valid login name which you had registered
#define MQTT_PASS        	"A23E8A046FB4C9ACF725095EE473550D9F7F4C3F" 	// MQTT密码					// you MQTT login password, same as above

#define STA_SSID 			"ChinaNet-mKJx"    	// WIFI名称					// your AP/router SSID to config your device networking
#define STA_PASS 			"zfahwudk" 	// WIFI密码					// your AP/router password
